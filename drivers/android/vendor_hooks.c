...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_enqueue_task_rt);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_dequeue_task_rt);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_sysbusy_on_somac);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_ecs_cpu_available);
