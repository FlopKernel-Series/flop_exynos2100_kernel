...
#endif
#if IS_ENABLED(CONFIG_LEDS_S2MPB02)
		if (sec_get_feat(SEC_FEAT_USES_S2MPB02)) {
...
#ifdef CAMERA_3RD_OIS
		|| (rsc_type == RESOURCE_TYPE_SENSOR3 && sec_get_mcd_feat(MCD_FEAT_TYPE_USUV3))
#endif
		)
		return true;
	else
...
{
	return (int)(((cis_shared_data *)cis_data)->is_data.sensor_hdr_mode == (int)SENSOR_HDR_MODE_2AEB ? true : false);
}
