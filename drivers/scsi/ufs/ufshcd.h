 ...
 *                  to update vendor specific state
...
struct ufs_hba {
	...
	/*
	 * This quirk needs to be enabled if the host controller handles
	 * WriteBooster flush control internally and manual toggling breaks it.
	 */
